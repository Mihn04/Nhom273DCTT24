    ...
    <div class="phan">
        ...
        <div style="margin-top: 60px;">
            ...
            <div style="position: relative;">
                <input required class="btn" type="text" style="color: #828282;" name="nickname" id="nicknameInput" value="<?php if(isset($user['taikhoan'])){echo $user['taikhoan']; }?>" readonly>
                ...
                <div id="editDiv" style="top: 17px;
                                        ...
                                        border-radius: 15px;">
                    <input required type="text" style="padding: 5px 15px;
                                                border-radius: 5px;
                                                border: 1px solid #0000002b;
                                                background-clip: content-box;
            ...
            <div>
                <input required class="btn" type="text" style="color: #828282;" name="" id="" value="<?php if(isset($user['gioitinh'])){echo $user['gioitinh']; }?>" readonly>   
            </div>
            <label for="">Tài Khoản</label>
            <div>
                <input required class="btn" type="text" style="color: #828282;" name="" id="" value="<?php if(isset($user['quyen'])){echo $user['quyen']; }?>" readonly>
            </div>
            <label for="">Mật khẩu</label>
            <div>
                <input required class="btn" type="password" style="color: #828282;" name="" id="pass" value="<?php if(isset($user['matkhau'])){echo $user['matkhau']; }?>" readonly>
                ...
                width: 195px;
                                        ...
                                        transform: translate(-100%, -50%);
                                        border-radius: 15px;">
                    <input required type="password" style="padding: 5px 15px;
                                                border-radius: 5px;
                                                border: 1px solid #0000002b;
                                                background-clip: content-box;
            ...
            <div>
                <input required class="btn" type="text" style="color: #828282;" name="" id="" value="<?php if(isset($user['sdt'])){echo $user['sdt']; }?>" readonly>
            </div>
            <label for="">Email</label>
            <div>
                <input required class="btn" type="email" style="color: #828282;" name="" id="" value="<?php if(isset($user['gmail'])){echo $user['gmail']; }?>" readonly>
            </div>
        </div>
        <div style="text-align: center;">
