...
<body>
    <header>
        ...
        <div class="btn-dialog">
          <a href="#themkhachsan"><button>Thêm thành phố</button></a>
        </div>
        ...
        <div class="tbdskhachsan">
          <h2>Danh sách thành phố</h2>
             <table class="table hover">
                <thead>
                    <tr>
                        <td class ="cot-name">Tên thành phố</td>
                   ...
                   $xid = $_GET["xid"];
                     ...
                     if(isset($_POST['search'])&&($_POST!="")){
                       ...
                       $search = "";
                         ...
                         if ($search != '') {
                           $listquerry = "SELECT * FROM city WHERE city LIKE '%" . $search . "%' && idCountry = $xid" ;
                         }
                           else 
                                 $listquerry = "SELECT * FROM city WHERE idCountry = $xid";
                  ...
                  ?>
                         <tbody>
                                  <tr>
                                     ...
                                     <td><?php echo $row["detailCity"]; ?></td>
                                     <td><img class ="tbimg" src="./picture/<?php echo $row["pictureCity"]; ?>"></td>
                                     <td>
                                       <a href="suathanhpho.php?id=<?php echo $row['id'];?>"><button class = "btn-sua">Sửa</button></a> 
                                       <a onclick="return confirm('Bạn có chắc muốn xóa đất nước này không?');" href="xoathanhpho.php?xid=<?php echo $row['id'];?>&&idCountry=<?php echo $row['idCountry'] ?>"><button class = "btn-xoa">Xóa</button></a>
                                     </td>
                                   </tr>
                                   <?php
                                     }
             ...
             <section class="dialog-themkhachsan" id="themkhachsan">
               ...
               <h2>Thêm thành phố</h2>
                 <div class="form-them">
                 <form action="themthanhpho.php" method="post" enctype="multipart/form-data">
                     <div class="form-group">
                         <label for="nameCity">Tên thành phố :</label>
                         <input required type="text" name = "nameCity" class="form-control" placeholder="Nhập tên thành phố" id="nameCity">
                       </div>
                       <div class="form-group">
                         <label for="detailCity">Chi tiết:</label>
                         <input required type="text" name ="detailCity" class="form-control" placeholder="Nhập chi tiết" id="detailCity">
                       </div>
                    <div class="form-group">
                      <label for="pictureCity">Ảnh :</label>
                      <input required type="file" name ="pictureCity" class="form-control" placeholder="Nhập ảnh" id="pictureCity">
                    </div>
                    <input required hidden type="text" name ="idCountry"  class="form-control" value="<?php echo $xid ?>" placeholder="Nhập nội dung" id="idCountry">
              <div class="form-group">
