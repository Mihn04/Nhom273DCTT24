...
$danh_sach_tk_thang = "SELECT MONTH(payDayBill) as payMonthBill, SUM(priceOrderBill) as total FROM bill WHERE YEAR(payDayBill) = $year GROUP BY MONTH(payDayBill) ORDER BY payDayBill LIMIT 12";
...
?>
        <h2 class="h2-month">Doanh thu khách sạn theo tháng của năm <?php echo $year ?></h2>
