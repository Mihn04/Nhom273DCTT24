...
$sua_dat_nuoc = "SELECT * FROM country WHERE id=$id";
$ketqua = mysqli_query($conn, $sua_dat_nuoc);
...
<div class="container">
        <div class = panel-datnuoc>
        <form action="capnhatdatnuoc.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value ="<?php echo $id;?>" id="">
            <div class="form-group-datnuoc">
                <label for="nameCountry">Tên đất nước :</label>
                <input required type="text" name = "nameCountry" class="form-control" value ="<?php echo $row["nameCountry"];?>" placeholder="Nhập tên đất nước" id="nameCountry">
            </div>
            <div class="form-group-datnuoc">
                <label for="detailCountry">Chi tiết:</label>
                <input required type="text" name ="detailCountry" class="form-control" value ="<?php echo $row["detailCountry"];?>" placeholder="Nhập chi tiết" id="detailCountry">
                </div>
            <div class="form-group-datnuoc">
                <label for="pictureCountry">Ảnh :</label>
                <input  type="file" name ="pictureCountry" class="form-control" placeholder="Nhập ảnh" id="pictureCountry">
            </div>
            <div class="form-group-datnuoc">
