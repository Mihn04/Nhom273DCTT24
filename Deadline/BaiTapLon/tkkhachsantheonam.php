...
$danh_sach_tk_nam = "SELECT YEAR(payDayBill) as payYearBill, SUM(priceOrderBill) as total FROM bill GROUP BY YEAR(payDayBill) ORDER BY payDayBill LIMIT 6";
...
<body>
    ...
    <div class="menu">
        ...
        <h2 class ="h2-year">Doanh thu khách sạn theo năm</h2>
