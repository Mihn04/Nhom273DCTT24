...
$sua_khach_san = "SELECT * FROM hotel WHERE id=$id";
$ketqua = mysqli_query($conn, $sua_khach_san);
...
<div class="container">
        <div class = panel>
        <form action="capnhatkhachsan.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value ="<?php echo $id;?>" id="">
            <div class="form-group">
                <label for="nameHotel">Tên khách sạn :</label>
                <input required type="text" name = "nameHotel" class="form-control" value ="<?php echo $row["nameHotel"];?>" placeholder="Nhập tên khách sạn" id="nameHotel">
            </div>
            <div class="form-group">
                <label for="introHotel">Tiêu đề :</label>
                <input required type="text" name ="introHotel" class="form-control" value ="<?php echo $row["introHotel"];?>" placeholder="Nhập tiêu đề" id="introHotel">
            </div>
            <div class="form-group">
                <label for="detailHotel">Chi tiết:</label>
                <input required type="text" name ="detailHotel" class="form-control" value ="<?php echo $row["detailHotel"];?>" placeholder="Nhập chi tiết" id="detailHotel">
            </div>
            <div class="form-group">
            <label for="cityHotel">Tên thành phố :</label>
            <select required name="cityHotel" class="form-control" id="cityHotel">
            <option value="<?php echo $row["cityHotel"] ?>"><?php echo $row["cityHotel"] ?></option>
                <?php
                    require_once 'ketnoi.php';
                ...
                ?>
                    <option value="<?php echo $kq["nameCity"] ?>"><?php echo $kq["nameCity"] ?></option>
                <?php
                }
                ?>
            </select>
            ...
            <div class="form-group">
                ...
                <input required type="text" name ="roadHotel" class="form-control" value ="<?php echo $row["roadHotel"];?>" placeholder="Nhập tên đường" id="roadHotel">
            </div>
            <div class="form-group">
                <label for="numberHotel">Số nhà :</label>
                <input type="text" name ="numberHotel" class="form-control" value ="<?php echo $row["numberHotel"];?>" placeholder="Nhập số nhà" id="numberHotel">
            </div>
            <div class="form-group">
                <label for="pictureHotel">Ảnh :</label>
                <input  type="file" name ="pictureHotel" class="form-control" placeholder="Nhập ảnh" id="pictureHotel">
            </div>
            <input hidden type="text" name ="idCountry" class="form-control" value ="<?php echo $row["idCountry"];?>" id="idCountry">
            <div class="form-group">
