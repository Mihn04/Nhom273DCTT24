...
$sua_thanh_pho = "SELECT * FROM city WHERE id=$id";
$ketqua = mysqli_query($conn, $sua_thanh_pho);
...
<div class="container">
        <div class = panel-thanhpho>
        <form action="capnhatthanhpho.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value ="<?php echo $id;?>" id="">
            <div class="form-group-thanhpho">
                <label for="nameCity">Tên thành phố :</label>
                <input required type="text" name = "nameCity" class="form-control" value ="<?php echo $row["nameCity"];?>" placeholder="Nhập tên đất nước" id="nameCity">
            </div>
            <div class="form-group-thanhpho">
                <label for="detailCity">Chi tiết:</label>
                <input required type="text" name ="detailCity" class="form-control" value ="<?php echo $row["detailCity"];?>" placeholder="Nhập chi tiết" id="detailCity">
                </div>
            <div class="form-group-thanhpho">
                <label for="pictureCity">Ảnh :</label>
                <input  type="file" name ="pictureCity" class="form-control" placeholder="Nhập ảnh" id="pictureCity">
            </div>
            <input required hidden type="text" name ="idCountry"  class="form-control" value="<?php echo $row["idCountry"] ?>" placeholder="Nhập nội dung" id="idCountry">
            <div class="form-group-thanhpho">
